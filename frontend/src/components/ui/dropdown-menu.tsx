...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[10rem] overflow-hidden rounded bg-bg-elevated border border-border",
        "p-1 text-text-primary shadow-card",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-2xs font-mono text-text-muted uppercase tracking-wider", inset && "pl-8", className)}
    {...props}
  />
));
